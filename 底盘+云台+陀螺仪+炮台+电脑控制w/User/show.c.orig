...
float Vol;
extern int Balance_Pwm,Velocity_Pwm,Moto1;
/**************************************************************************
函数功能：OLED显示
入口参数：无
返回  值：无
...
{    
	  ...
	  int app_2,app_3,app_4;
		app_4=(Voltage-740);		if(app_4<0)app_4=0;if(app_4>100)app_4=100;   //对电压数据进行处理
...
{   
    Vol=(float)Voltage/100;
		...
		//DataScope_Get_Channel_Data( Balance_Pwm, 2 );         //显示超声波测量的距离 单位：CM 
		DataScope_Get_Channel_Data( Velocity_Pwm, 3 );                 //显示电池电压 单位：V
