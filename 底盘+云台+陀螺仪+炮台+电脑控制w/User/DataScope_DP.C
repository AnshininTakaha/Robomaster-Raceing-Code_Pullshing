...
void DataScope(void)
{
//		DataScope_Get_Channel_Data( chassis_data.wheel[1].Read_Rotate, 1 );
//		DataScope_Get_Channel_Data( chassis_data.wheel[1].ActualSpeed , 2 );
    DataScope_Get_Channel_Data( M3508s[1].realSpeed, 1 );
    DataScope_Get_Channel_Data(M3508s[2].realSpeed, 2 );
    //DataScope_Get_Channel_Data( Balance_Pwm, 2 );
